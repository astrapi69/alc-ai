...
[`templates/`](../templates/), the shipped **lesson sets** under
[`sets/de/`](../sets/de/), the validator, and CI.
...
- Read a shipped lesson, e.g.
  [`sets/de/ki-einsteiger/lessons/01-ki-im-alltag.json`](../sets/de/ki-einsteiger/lessons/01-ki-im-alltag.json)
